    ...
    <>
      ...
      <div className="flex flex-col md:px-12 lg:flex-row lg:justify-between lg:px-0">
        ...
        <div className="flex h-min flex-col gap-4 border-black pl-6 pb-6 lg:border-b lg:border-l lg:pr-12">
          <p className="shadow-text mr-32 pt-6 font-franklin text-2xl font-extralight uppercase md:mr-[380px] lg:mb-2 lg:mr-0 lg:ml-6">
            BUY ALL EVENTS
          </p>
          <div className="flex flex-row items-center gap-12 font-franklin lg:py-2 lg:pl-6">
            <p className="text-lg">TOTAL</p>
            <p className="">{formatCurrency(getCartTotal())}</p>
          </div>
