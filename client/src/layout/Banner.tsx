  ...
  return (
    <>
      ...
      <div className="relative flex min-h-[200px] flex-col overflow-hidden border-b border-black md:hidden">
        ...
        <Circle className="-right-8 top-2 bg-aubergine" size={65}></Circle>

        <div className="absolute bottom-0 h-[70px] pl-2">
          <Triangle className="border-b-[70px] border-l-[40px] border-r-[40px] border-b-beige-muted"></Triangle>
        </div>
      ...
      <div className="relative hidden min-h-[200px] w-auto flex-col overflow-hidden border-b border-black pl-24 leading-none md:flex">
        ...
        <Circle className="-right-12 bottom-8 bg-aubergine" size={100}></Circle>

        <div className="absolute bottom-0 h-[85px]">
          <Triangle className="border-b-[85px] border-l-[50px] border-r-[50px] border-b-beige-muted"></Triangle>
        </div>
        ...
        <Triangle className="right-[140px] top-8 rotate-[24deg] border-l-[40px] border-r-[40px] border-t-[70px] border-t-beige-muted md:hidden lg:block" />
        <Square
          className="bottom-6 right-[200px] rotate-[75deg] bg-brown-muted md:hidden lg:block"
          size={65}
        ></Square>
      </div>
    </>
